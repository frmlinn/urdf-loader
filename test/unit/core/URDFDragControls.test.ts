...
describe('URDFDragControls Module', () => {
    ...
    // =========================================================================
    // SECTION: Function: isJoint()
    // =========================================================================
    describe('Function: isJoint()', () => {
    ...
    // =========================================================================
    // SECTION: Class: URDFDragControls (Base Class)
    // =========================================================================
    describe('Class: URDFDragControls', () => {
        let scene: Scene;
        ...
        describe('Properties: Default Callbacks & Handlers', () => {
    ...
    // =========================================================================
    // SECTION: Class: PointerURDFDragControls (DOM Events Extension)
    // =========================================================================
    describe('Class: PointerURDFDragControls', () => {
        let scene: Scene;
        ...
        describe('constructor() & DOM Event Handlers', () => {
        ...
        describe('getRevoluteDelta() (Override)', () => {
